...
import CreateUserClassesSchedule, {
    UserClasseScheduleDTO,
} from '../services/custom-default/CreateUserClassesSchedule';
import ListClassesSchedule, {
    QueryDTO,
} from '../services/custom-default/ListClassesSchedule';
...
export default class ClassesController {
    ...
    async create(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const response = await new CreateUserClassesSchedule(
                data,
            ).execute();
